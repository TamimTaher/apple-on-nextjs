...
// Define types for model and size
interface ModelType {
  title: string;
  color: string[];
  img: string;
              ...
              <ul className="color-container">
                {models.map((item, i) => (
                  <li
                    ...
                    onClick={() => setModel(item)} // model items are properly typed
                  />
                ))}
              </ul>
              ...
              <button className="size-btn-container">
                {sizes.map(({ label, value }) => (
                  <span
                    ...
                    onClick={() => setSize(value as "small" | "large")} // Explicitly casting `value` to "small" | "large"
                  >
                    {label}
                  </span>
                ))}
